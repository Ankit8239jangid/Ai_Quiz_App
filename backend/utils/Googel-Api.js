...
// TEXT RESPONSE
async function generateTextResponse(prompt , numQuestions) {
...
1. Ask the user for:
   - Quiz title/topic
2. Confirm the inputs and then generate a quiz in strict JSON format.
...
Expected response format:
{
  ...
  "questions": [
    ...
    const result = await model.generateContent(`${prompt}  and crete  ${numQuestions} of Questions`);
